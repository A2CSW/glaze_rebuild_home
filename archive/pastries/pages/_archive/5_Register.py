Good — this is now the first page where we need to do slightly more than import cleanup, but still keep it minimal and safe.

✔ CLEANED VERSION — 5_Register.py

Paste and overwrite the full file:
...
# SAFE LOAD (keeps local CSV dependency explicit)
